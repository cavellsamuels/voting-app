...
<body class="font-sans text-gray-900 text-sm">
    ...
    <main class="container mx-auto max-w-custom flex" style="max-width: 1000px;">
        <div class="w-70 mr-5">
            Add Idea Form Here. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat dolorum eaque
            pariatur laudantium quod natus hic cupiditate quisquam unde non tenetur deserunt modi, doloremque, sapiente
            in ad omnis quidem consequuntur tempore illo nesciunt? Sapiente consequuntur rerum fugiat id necessitatibus
            officiis.
        </div>
        <div class="w-175">
